...
from clover.apps.fridge.adapter.outbound.repositories.receipt_line_pg_repository import (
...
from clover.apps.fridge.app.use_cases.receipt_line_interactor import (
    ReceiptLineInteractor,
)
