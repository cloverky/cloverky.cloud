...
from clover.apps.fridge.adapter.outbound.repositories.category_pg_repository import (
...
def get_category_repository(db: AsyncSession = Depends(get_db)) -> CategoryPgRepository:
